...
<div class="max-w-4xl mx-auto bg-white border border-outline-variant shadow-sm rounded-xl overflow-hidden animate-in fade-in zoom-in-95 duration-500">
    ...
    <div class="px-8 py-6 border-b border-outline-variant flex items-center justify-between bg-surface-container-low/50">
        <div>
            ...
            <p class="text-sm text-on-surface-variant">Define project requirements and assign a lead.</p>
        </div>
        <a href="/tasks" class="text-on-surface-variant hover:bg-surface-container rounded-full p-2 transition-colors">
    ...
    <form class="p-8 space-y-8">
            ...
            <div class="md:col-span-7 space-y-8">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <input class="w-full border-outline-variant focus:border-primary focus:ring-1 focus:ring-primary rounded-lg text-sm py-3 px-4 transition-all bg-surface/50" 
                           id="title" placeholder="e.g., Implement Authentication Flow" type="text"/>
                </div>
                <!-- Description -->
                <div class="flex flex-col gap-2">
                    ...
                    <textarea class="w-full border-outline-variant focus:border-primary focus:ring-1 focus:ring-primary rounded-lg text-sm py-3 px-4 transition-all resize-none bg-surface/50" 
                              id="description" placeholder="Detail the technical requirements and scope..." rows="6"></textarea>
                </div>
                <!-- Meta Grid -->
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <select class="w-full border-outline-variant focus:border-primary focus:ring-1 focus:ring-primary rounded-lg text-sm py-3 px-4 transition-all appearance-none bg-surface/50" id="priority">
            ...
            <div class="md:col-span-5 flex flex-col gap-2">
                ...
                <div class="border border-outline-variant rounded-lg overflow-hidden bg-surface-container-lowest flex-1 flex flex-col">
                    ...
                    <div class="flex-1 overflow-y-auto divide-y divide-outline-variant">
                        @php
                            $team = [
                                ['name' => 'Jane Smith', 'role' => 'Frontend Lead', 'img' => 'https://lh3.googleusercontent.com/aida-public/AB6AXuCyB6aLDWb6LdTXNd1B8OrgRrHUU-plU5NU687gWaU0A0uVekIl7pjleup5y_ZHTem6I1xwp7Oh21BJtExq-jB0Wi5T6aCtuqU1b3fjK6WO5d7OUduzV9cOu3WGL6q6HGWNtse4ISrf8FB5Vs3WMHRSVqTmX1R_Y3x17fmO9fNoR8WDtpRXa_814AGvifqhA7ij70JhiHiNfWQYwr8eyH-YSYV_4DgCKFCi3fV3E6jiAWiKsHLAwj1o_Uk0Za_gy8m5DbobYN6yQMZR'],
        ...
        <div class="pt-8 border-t border-outline-variant flex items-center justify-end gap-4">
            <button class="px-6 py-2.5 text-sm font-bold text-on-surface-variant hover:bg-surface-container rounded-lg transition-all" type="button">
                Cancel
            </button>
