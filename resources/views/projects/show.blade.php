                    ...
                    <div class="flex justify-between items-start mb-6">
                        <div class="space-y-3">
                            ...
                            <div class="flex flex-wrap gap-2">
                                @if ($task->priority)
                                    <span
                                        class="{{ $task->priority === 'high' ? 'bg-error/10 text-error' : ($task->priority === 'medium' ? 'bg-tertiary/10 text-tertiary' : 'bg-surface-container text-outline') }} px-2.5 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider">
                                        {{ $task->priority }}
                                    </span>
                                @endif
                            </div>
