...
@section('title', '404 | DevTrack')
@section('page-title', 'Not Found')

@section('content')
<div class="min-h-[60vh] flex items-center justify-center">
    <div class="text-center space-y-6 animate-in fade-in zoom-in-95 duration-500">
        <div class="w-32 h-32 mx-auto bg-surface-container rounded-full flex items-center justify-center">
            <span class="material-symbols-outlined text-[80px] text-outline">search_off</span>
        </div>
        
        <div class="space-y-2">
            <h1 class="text-6xl font-black text-outline">404</h1>
            <h2 class="text-2xl font-bold text-on-surface">Page Not Found</h2>
            <p class="text-outline text-sm max-w-md mx-auto">The page you're looking for doesn't exist or has been moved.</p>
        </div>
